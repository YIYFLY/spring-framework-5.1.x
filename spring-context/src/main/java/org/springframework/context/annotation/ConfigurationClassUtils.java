...
abstract class ConfigurationClassUtils {
	...
	public static boolean checkConfigurationClassCandidate(BeanDefinition beanDef, MetadataReaderFactory metadataReaderFactory) {
		...
		// 这几个判断不重要，看下面判断之后的代码（如果 bd 是 Annotatedbd 类型的并且传入的className和Metadata中的className一致）
		{
		...
		/**
		 * 如果metadata中有 @Configuration注解 表明是一个全注解的类，设置属性为 full
		 * 如果没有Configuration，但是有 @Component，@ComponentScan，@Import，@ImportResource，@Bean 就是一个部分注解的类，设置属性为 lite
		 * 如果都没有，就返回false
		 */
